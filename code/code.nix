...
, direct-sqlite, directory, file-embed, http-client, http-types
, lib, lucid, lucid-svg, mtl, process, QuickCheck, random, tasty
...
mkDerivation {
  ...
  executableHaskellDepends = [
    ...
    directory file-embed http-client http-types lucid lucid-svg mtl
